...
export default function EmailMonitorTab() {
  ...
  const renderSubTabButtons = () => {
    ...
    console.log('EmailMonitorTab - Total de abas:', tabs.length, tabs.map(t => t.label));
  ...
  const renderMonitorDVRTab = () => (
    <div className="space-y-6">
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <h4 className="text-sm font-medium text-blue-900 mb-2">ℹ️ Monitor de Senha DVR Intelbras</h4>
        <p className="text-xs text-blue-700">
          Este monitor corrige automaticamente o bug do DVR Intelbras que corrompe a senha do email adicionando 16 caracteres fantasmas.
        </p>
      </div>

      <div className="text-center py-8">
        <p className="text-gray-600 mb-4">Para acessar o Monitor de DVR completo, visite:</p>
        <a
