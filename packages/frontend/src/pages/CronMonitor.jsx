...
export default function CronMonitor() {
  ...
  const fetchStatus = async () => {
    try {
      ...
      const cronResponse = await axios.get('/api/cron/status');
      setCronStatus(cronResponse.data);

      // Buscar status do barcode scanner
      const barcodeResponse = await axios.get('/api/barcode/status');
    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <div className="flex-1 overflow-auto lg:ml-0">
        ...
        <div className="lg:hidden bg-white shadow-sm p-4 flex items-center justify-between">
          ...
          <h1 className="text-lg font-semibold text-gray-900">Monitoramento</h1>
          <button
            onClick={logout}
        ...
        <main className="p-4 lg:p-8">
          <div className="max-w-7xl mx-auto">
            {/* Header */}
            <div className="mb-8">
              <h1 className="text-3xl font-bold text-gray-900">🔄 Monitoramento de Serviços</h1>
