        ...
        <div className="bg-gradient-to-r from-teal-500 to-teal-600 text-white p-4 shadow">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              <h1 className="text-xl sm:text-2xl font-bold">✅ Modelos de Alternativas</h1>
              <p className="text-xs sm:text-sm opacity-90">Conjuntos reutilizáveis de respostas (ícones, valores)</p>
            </div>
          </div>
        </div>
