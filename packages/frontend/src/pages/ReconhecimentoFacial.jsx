                      ...
                      <div className="aspect-square bg-gray-200 relative overflow-hidden">
                        {log.image_path ? (
                          <img
                            ...
                            onError={(e) => {
                              // Se imagem não carregar, mostrar placeholder
                        ...
                        <div
                          className="w-full h-full bg-gray-300 items-center justify-center text-gray-500 flex-col"
                          style={{ display: log.image_path ? 'none' : 'flex' }}
                        >
